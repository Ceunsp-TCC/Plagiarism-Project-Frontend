...
import { columns } from '@/app/(private)/school/teachers/objects'
import { useTeachersTable } from '@/app/(private)/school/teachers/hooks'
import {
  transformColorBadgeStatus,
  transformTextBadgeStatus,
} from '@/app/(private)/school/teachers/functions'
